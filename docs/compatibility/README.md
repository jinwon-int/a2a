...
- [Standalone worker terminal evidence validation](../validation/standalone-worker-terminal-evidence.md) — maps Done / PR / Block evidence to the standalone HTTP reference worker shape.
