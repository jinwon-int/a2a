...
2. Merge this A2A Plane validation PR after local gates pass. It closes [a2a-plane#186](https://github.com/jinwon-int/a2a-plane/issues/186).
...
4. If more than one A2A Plane PR from the round exists, run the merge train locally before merging the first PR:
